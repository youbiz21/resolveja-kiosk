...
@Component({
  ...
  templateUrl: './tapete-form.component.html',
  styleUrl: './tapete-form.component.scss'
})
export class TapeteFormComponent implements OnInit{
  form = input.required<ReturnType<typeof TapeteFormFactory>>();
